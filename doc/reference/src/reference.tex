...
\multicolumn{2}{p{.97\textwidth}}{When switch\_model = `FromFile' the following input variables must be provided:}
\\ \hline
\textbf{SEYFile} & Name of the file with SEY data (the format of the file are three columns with parameters: Energy,Reflected Part and SEY .
