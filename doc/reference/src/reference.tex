...
\textbf{t\_sc\_ON}& [s] Electron space charge forces are neglected for t<t\_sc\_ON -- normally t\_sc\_ON=0. \\ \hline
	...
	\textbf{flag\_em\_tracking} & (optional -- default = False) Forces generated by electrons are computed using electromagnetic potentials instead of quasi-electrostatic approximation (for more information see \url{https://indico.cern.ch/event/840676/contributions/3532754/}).
    \\ \hline
\end{longtable}
