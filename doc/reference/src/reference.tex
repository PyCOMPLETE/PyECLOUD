...
\\ \hline
\textbf{sparse\_solver} & [optional] choices are 'klu', 'scipy\_slu' [default'
\\ \hline
\end{longtable}
...
%\begin{longtable}{p{0.42\textwidth}p{0.53\textwidth}}
%\hline\endfirsthead\hline\endhead\rowcolor{Gray}
%\multicolumn{2}{p{.97\textwidth}}{\textbf{Initial angular distribution of new MPs relative to the surface normal vector}}
%\\ \hline
...
%\\ \hline
%\textbf{photoelectron\_angle\_distribution} & See secondary\_angle\_distribution'
%\\
%\hline
%\end{longtable}
