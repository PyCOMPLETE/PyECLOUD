...
\textbf{filename\_chm} & Name of file containing horizontal and vertical vertexes of the chamber profile.
    If the photoemission mode 'per\_segment' is used, the chamber file must also contain the cumulative distribution function of the emission probability for each segment.\\ \hline
