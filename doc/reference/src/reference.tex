...
Defining $N\_{\mathrm{pass}}$ the number of bunch passages and $N\_{\mathrm{bins}}$ the number of bins in the horizontal plane used to produce histograms, the main output variables have the following shapes:
...
\begin{longtable}
    ...
    \\\hline
    t\_hist($N\_{\mathrm{pass}}$) & & \\\hline
    xg\_hist($N\_{\mathrm{bins}}$ ) & & \\\hline
    N\_mp\_corrected\_pass($N\_{\mathrm{pass}}$) & & \\\hline
    N\_mp\_impact\_pass($N\_{\mathrm{pass}}$) & & \\\hline
    N\_mp\_pass($N\_{\mathrm{pass}}$) & & \\\hline
    N\_mp\_ref\_pass($N\_{\mathrm{pass}}$) & & \\\hline
    energ\_eV\_impact\_hist($N\_{\mathrm{pass}}$, $N\_{\mathrm{bins}}$ ) & & \\\hline
    nel\_hist($N\_{\mathrm{pass}}$, $N\_{\mathrm{bins}}$ ) & & \\\hline
    nel\_impact\_hist\_scrub($N\_{\mathrm{pass}}$, $N\_{\mathrm{bins}}$ ) & & \\\hline
    nel\_impact\_hist\_tot($N\_{\mathrm{pass}}$, $N\_{\mathrm{bins}}$ ) & & \\\hline
 & & \\\hline
\end{longtable}
