...
def read_input_files_and_init_components(pyecl_input_folder='./', skip_beam=False,
    ...
    impact_man = impact_man_class(cc.switch_no_increase_energy, chamb, sey_mod, cc.E_th, cc.sigmafit, cc.mufit, cc.Dx_hist,
                                  cc.scrub_en_th, cc.Nbin_En_hist, cc.En_hist_max, cc.thresh_low_energy, flag_seg,
                                  cc.cos_angle_width, cc.secondary_angle_distribution)
