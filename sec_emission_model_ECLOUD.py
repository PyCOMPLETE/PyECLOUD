...
class SEY_model_ECLOUD:
    def __init__(self, Emax,del_max,R0, E0, s, flag_costheta_delta_scale, flag_costheta_Emax_shift):
            self.Emax = Emax
    ...
    def SEY_process(self,nel_impact,E_impact_eV, costheta_impact, i_impact):
            yiel, ref_frac = self.yield_(E_impact_eV, costheta_impact)
    ...
    def yield_(self, E_impact_eV, costheta_impact):
        return yield_fun2(E_impact_eV,costheta_impact,self.Emax,self.del_max, self.R0, self.E0, self.s,
                          self.flag_costheta_delta_scale, self.flag_costheta_Emax_shift)
