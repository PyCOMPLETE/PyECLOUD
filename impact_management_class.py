...
from numpy import array, ceil, pi, cos, sin, zeros, sqrt, sum
#from numpy import *
import sec_emission
        ...
        if MP_e.N_mp>0:
            ...
            if Nimpact>0:
                ...
                if N_true_sec>0:
                    ...
                    En_truesec_eV=sec_emission.hilleret_model2(switch_no_increase_energy, N_true_sec, sigmafit, mufit, E_th, E_impact_eV[flag_truesec], thresh_low_energy);
                    ...
                    while n_add_step>0:
                        En_truesec_eV=sec_emission.hilleret_model2(switch_no_increase_energy, n_add_step, sigmafit, mufit, E_th, E_impact_eV[flag_add], thresh_low_energy);
