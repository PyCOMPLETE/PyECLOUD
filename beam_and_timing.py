...
class beam_and_timing:
    def __init__(self,flag_bunched_beam, fact_beam, coast_dens, lam_q, beam_field_file, lam_th_beam_field,
    ...
    def get_beam_eletric_field(self, MP_e):
        ...
        if (self.lam_t_curr>self.lam_th_beam_field) and (MP_e.N_mp>0):
            ...
            Ex_n_beam=self.lam_q*self.lam_t_curr*Ex_n_beam;
            Ey_n_beam=self.lam_q*self.lam_t_curr*Ey_n_beam;
