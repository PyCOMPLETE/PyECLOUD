...
class photoemission:
    ...
    def __init__(self, inv_CDF_refl_photoem_file, k_pe_st, refl_frac, e_pe_sigma, e_pe_max,alimit, \
        ...
        self.get_energy = get_energy_distribution_func(energy_distribution, e_pe_sigma, e_pe_max)
...
class photoemission_from_file(object):
    def __init__(self, photoemission_file, energy_distribution, e_pe_sigma, e_pe_max):
