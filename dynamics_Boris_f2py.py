...
class pusher_Boris():
    ...
    def stepcustomDt(self, MP_e, Ex_n, Ey_n, Ez_n=0., Bx_sc_n=None, By_sc_n=None, Bz_sc_n=None, Dt_substep=None, N_sub_steps=None):

        if  Bx_sc_n is not None or By_sc_n is not None or  Bz_sc_n is not None,:
